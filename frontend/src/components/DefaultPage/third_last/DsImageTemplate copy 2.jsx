...
function IntSDataSmellsImageTemplate() {
  const {state} = useLocation();
  const metricintasstring  = state.ok;
    ...
    <div className={styles.container}>
      ...
      <div className={styles.chartContainer}> 
        <div className={styles.chartWrapper}>
          <IntegerAsStringChart obj={metricintasstring} />
...
export default IntSDataSmellsImageTemplate;
