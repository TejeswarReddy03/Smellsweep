...
function DateDataSmellsImageTemplate() {
  const {state} = useLocation();
  const metricsdatetimesmell  = state.ok;
    ...
    <div className={styles.container}>
      ...
      <div className={styles.chartContainer}> 
        <div className={styles.chartWrapper}>
          <Datetimefun datetime_obj={metricsdatetimesmell} />
...
export default DateDataSmellsImageTemplate;
